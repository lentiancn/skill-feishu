...
| 字段 | 所需权限 |
|------|---------|
| `union_id` | 统一用户标识(contact:user.base:readonly) |
| `user_id` | 获取用户 user ID(contact:user.employee_id:readonly) |
| `open_id` | 应用内用户标识(contact:user.base:readonly) |
| `name` | 获取用户基本信息(contact:user.base:readonly) |
| `en_name` | 获取用户基本信息(contact:user.base:readonly) |
| `nickname` | 获取用户基本信息(contact:user.base:readonly) |
| `email` | 获取用户邮箱信息(contact:user.email:readonly) |
| `mobile` | 获取用户手机号(contact:user.phone:readonly) |
| `gender` | 获取用户性别(contact:user.gender:readonly) |
| `avatar` | 获取用户基本信息(contact:user.base:readonly) |
| `status` | 获取用户受雇信息(contact:user.employee:readonly) |
| `department_ids` | 获取用户组织架构信息(contact:user.department:readonly) |
| `leader_user_id` | 获取用户组织架构信息(contact:user.department:readonly) |
| `city` | 获取用户受雇信息(contact:user.employee:readonly) |
| `country` | 获取用户受雇信息(contact:user.employee:readonly) |
| `work_station` | 获取用户受雇信息(contact:user.employee:readonly) |
| `join_time` | 获取用户受雇信息(contact:user.employee:readonly) |
| `is_tenant_manager` | 获取用户受雇信息(contact:user.employee:readonly) |
| `employee_no` | 查看成员工号(contact:user.employee_number:read) |
| `employee_type` | 获取用户受雇信息(contact:user.employee:readonly) |
| `orders` | 获取用户组织架构信息(contact:user.department:readonly) |
| `custom_attrs` | 获取用户受雇信息(contact:user.employee:readonly) |
| `enterprise_email` | 获取用户受雇信息(contact:user.employee:readonly) |
| `job_title` | 获取用户受雇信息(contact:user.employee:readonly) |
| `geo` | 查看成员数据驻留地(contact:user.user_geo) |
| `job_level_id` | 查询用户职级(contact:user.job_level:readonly) |
| `job_family_id` | 查询用户所属的工作序列(contact:user.job_family:readonly) |
| `department_path` | 获取成员所在部门路径(contact:user.department_path:readonly) |
| `dotted_line_leader_user_ids` | 查看成员的虚线上级 ID(contact:user.dotted_line_leader_info.read) |
